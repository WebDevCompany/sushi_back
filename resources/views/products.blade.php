...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/Vlad/products.css') }}">
    ...
    <div class="main-content">
        ...
        <div class="content__product">
            ...
            <div class="product__item">
                <div class="product__img"> <img src=" {{asset('images/Vlad/product/Rectangle 3-2.png')}} " alt="">  </div>
            ...
            <div class="product__item">
                <div class="product__img"> <img src=" {{asset('images/Vlad/product/Rectangle 3-3.png')}} " alt=""></div>
            ...
            <div class="product__item">
                <div class="product__img"> <img src=" {{asset('images/Vlad/product/Rectangle 3-4.png')}} " alt=""></div>
            ...
            <div class="product__item">
                <div class="product__img"> <img src=" {{asset('images/Vlad/product/Rectangle 3-5.png')}} " alt=""></div>
            ...
            <div class="product__item">
                <div class="product__img"> <img src=" {{asset('images/Vlad/product/Rectangle 3-6.png')}} " alt=""></div>
            ...
            <div class="product__item">
                <div class="product__img"> <img src=" {{asset('images/Vlad/product/Rectangle 3-7.png')}} " alt=""></div>
            ...
            <div class="product__item">
                <div class="product__img"> <img src=" {{asset('images/Vlad/product/Rectangle 3-8.png')}} " alt=""></div>
            ...
            <div class="product__item">
                <div class="product__img"> <img src=" {{asset('images/Vlad/product/Rectangle 3-9.png')}} " alt=""></div>
